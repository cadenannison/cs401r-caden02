...
#
# ONE bucket with four prefixes, not four buckets. Name is
# ${project}-${environment}-data-${account_id} so it never collides across
# accounts and matches what environments/local's Makefile target expects.
